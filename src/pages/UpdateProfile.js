...
const UpdateProfile = ({ user, updateProfile }) => {
  ...
  const handleProfileUpdate = (e) => {
    ...
    const userProfile = {
      ...
      nitapian: isCollegeStudent, // Keeping original key for DB compatibility unless migration is planned
      psitian: isCollegeStudent,
      ...
      college: (isCollegeStudent ? "PSIT" : data.get('collegeName'))
    }
  ...
  useEffect(() => {
    ...
    getDoc(doc(db, 'users', user.user.uid)).then(snap => {
      ...
      if (data.psitian === false || data.nitapian === false) setIsCollegeStudent(false);
      ...
      <div className='container'>
        ...
        <div className={styles['form-box']}>
          ...
          <form className={styles['login-form']} onSubmit={handleProfileUpdate} autoComplete='off'>
            ...
            <div className={cx(styles['form-field'])}>
              <label htmlFor='Individual'>Are you a student of PSIT? *</label>
