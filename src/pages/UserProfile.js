...
const UserProfile = ({ user, logoutUser }) => {
  ...
  useEffect(() => {
    if (profiledata && !fetching) {
      const qrStr = `Name ${profiledata.firstName} ${profiledata.lastName
        }, Registration Id ${user.user.uid} College ${profiledata.college
                      ...
                      {!fetching && Object.keys(registrations).length > 0 && (
                        <div className={styles.qr}>
                          ...
                          <div className={styles.ftr}>
                            <p>Autogenerated at www.footprints26.com</p>
                            <p>
