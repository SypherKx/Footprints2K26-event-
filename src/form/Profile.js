...
const Register = ({ user, updateProfile }) => {
  ...
  const handleProfileUpdate = (e) => {
    ...
    const userProfile = {
      ...
      nitapian: collegeStudent, // Legacy support
      psitian: collegeStudent,
      ...
      college: (collegeStudent ? "PSIT" : data.get('collegeName'))
    }
    ...
    <div className="MainFormComponent container">
      ...
      <form className='FormComponent' autoComplete="off" onSubmit={handleProfileUpdate}>
        ...
        <div className='formColumn'>
          ...
          <div className='FormLabel'>
            <label htmlFor="nitapian">Are You Student of PSIT Kanpur ?</label>
